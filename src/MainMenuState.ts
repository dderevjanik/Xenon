...
export class CMainMenuState extends CGameState {
    ...
    public create(): boolean {
        ...
        this.m_menu.setPosition(new Point(0, 275));
    ...
    public update(ctx: CanvasRenderingContext2D, controls: Controls): boolean {
        ...
        //this.m_pcflogo.drawImage(new Point(480, 400), ctx, pcflogo);

        ////	m_medium_font.setTextCursor(Point(0,50));
        ////	m_medium_font.justifyString("Xenon Demo");

        this.m_small_font.setTextCursor(new Point(0, 460));
        this.m_small_font.justifyString("Copyright 2000 The Bitmap Brothers");


        this.m_small_font.setTextCursor(new Point(0, 470));
        this.m_small_font.justifyString("Typescript conversion by Ian Wigley 2017");

        this.m_small_font.setTextCursor(new Point(2, 2));
